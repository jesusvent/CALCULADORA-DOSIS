...
const PROTOCOLS = [
  ...
  },
  {
    ...
    especies: ["gato"],
    notas: "Curan entre el 50-65% de los casos. No usar productos glucosados en fluidoterapia hasta que el gato coma. No usar anabolizantes ni corticoides. Dieta Feline C/D o P/D con alimentación forzada (sonda) 4 veces/día durante 3 meses. Si hay encefalopatía hepática: enemas tibios con lactulosa o neomicina, y lactulosa oral 0,5 ml/4,5 kg/día en 2-3 tomas junto con metronidazol 7,5 mg/kg 2-3 veces/día. Suplementos a dosis fija (no calculables por peso en esta app — consultar la dosis total antes de administrar): tiamina/vitamina B1 50-100 mg totales cada 12 h VO/SC/IM (su déficit produce midriasis, ceguera, ventroflexión de cabeza, ataxia y estupor); vitamina E 100-400 UI totales cada 24 h VO.",
    componentes: [
  ...
  },
  {
    ...
    especies: ["perro", "gato"],
    notas: "Pronóstico pobre sin cirugía (mortalidad >50% al año), pero siempre estabilizar médicamente al menos 1 mes antes de operar. Lactulosa (Duphalac) 0,5-1 ml/kg cada 8-12 h (o en enema si hay vómitos) — dosis en ml/kg, no incluida como componente calculable. Si hay convulsiones: levetiracetam de elección; si no, midazolam mejor que diazepam (seguido de infusión 0,1-0,25 mg/kg/min) o fenobarbital — la acepromazina no aumenta las convulsiones en estos pacientes. Dieta hipoalergénica. Premedicación quirúrgica: fentanilo o metadona + propofol, fluidos 5-10 ml/kg/h; si hipotensión, noradrenalina o bolos de albúmina.",
    componentes: [
