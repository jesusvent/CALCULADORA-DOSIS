...
const DRUGS = [
  ...
  // ---- Fármacos de "Descripción de especialidades: Aparato respiratorio" (Guía terapéutica
  // del animal de compañía, ConsultaVet, 8ª ed., Rejas López y cols.) — todos de uso off-label
  // (presentaciones de uso humano o veterinarias para otras especies, salvo que se indique lo
  // contrario). Todas las notas citan expresamente la fuente. ----
  {
    id: "budesonida",
